...
public class Multiplication {
    ...
    public static String multiplyUsingFFT(String a, String b) {
        ...
        com.jwetherell.algorithms.mathematics.FastFourierTransform.cooleyTukeyFFT(aCoefficients);
        com.jwetherell.algorithms.mathematics.FastFourierTransform.cooleyTukeyFFT(bCoefficients);
