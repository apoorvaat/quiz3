...
public class Primes {
    ...
    public static final boolean millerRabinTest(int number) {
        ...
        while (((number - 1) % com.jwetherell.algorithms.mathematics.Exponentiation.fastRecursiveExponentiation(2, maximumPowerOf2)) == 0)
            maximumPowerOf2++;
        maximumPowerOf2--;

        int d = (number - 1) / com.jwetherell.algorithms.mathematics.Exponentiation.fastRecursiveExponentiation(2, maximumPowerOf2);
        boolean isPrime = true;
        for (int a : witnesses) {
            if (a > number)
                break;
            if (com.jwetherell.algorithms.mathematics.Exponentiation.fastRecursiveExponentiationModulo(a, d, number) != 1) {
                boolean isLocalPrime = false;
                for (int r = 0; r < maximumPowerOf2; r++) {
                    if (com.jwetherell.algorithms.mathematics.Exponentiation.fastRecursiveExponentiationModulo(a, d * com.jwetherell.algorithms.mathematics.Exponentiation.fastRecursiveExponentiation(2, r), number) == (number - 1)) {
                        isLocalPrime = true;
                        break;
                    }
                }
